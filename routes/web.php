...
$router->group(['prefix' => 'api'], function() use ($router){
    ...
    $router->get('/asesor-grupal/{nivel}', [
        'uses'  => 'Asesor\AsesorController@getGrupalAll'
    ]);
    ...
    $router->get('/subsubtipo_actividad_all', [
        'uses'  => 'SubSubTipoActividad\SubSubTipoActividadController@getSubSubAll'
    ]);
